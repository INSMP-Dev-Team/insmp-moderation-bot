...
SETTING_DEFAULTS: dict[str, str] = {
    ...
    "TICKET_CUSTOM_ROLE_PING_ROLE_ID": "0",
    "TICKET_AFFILIATE_PING_ROLE_ID": "0",
...
SETTING_DESCRIPTIONS: dict[str, str] = {
    ...
    "TICKET_CUSTOM_ROLE_PING_ROLE_ID": "Role ID pinged for Custom Role tickets.",
    "TICKET_AFFILIATE_PING_ROLE_ID": "Role ID pinged for Affiliate Server tickets.",
...
ENV_MIGRATIONS: dict[str, tuple[str, ...]] = {
    ...
    "TICKET_CUSTOM_ROLE_PING_ROLE_ID": (TICKET_CUSTOM_ROLE_PING_ID,),
    "TICKET_AFFILIATE_PING_ROLE_ID": (TICKET_AFFILIATE_PING_ROLE_ID,),
...
def reload_settings() -> None:
    ...
    global TICKET_CUSTOM_ROLE_PING_ROLE_ID
    global TICKET_AFFILIATE_PING_ROLE_ID
    ...
    TICKET_CUSTOM_ROLE_PING_ROLE_ID = _int_setting("TICKET_CUSTOM_ROLE_PING_ROLE_ID")
    TICKET_AFFILIATE_PING_ROLE_ID = _int_setting(TICKET_AFFILIATE_PING_ROLE_ID)
